...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2020 at 04:03 PM
...
CREATE TABLE `payments` (
  ...
  `status` varchar(25) COLLATE utf8_unicode_ci NOT NULL COMMENT '0=Pending, 1=Success, 2=Failed',
  `RetreivalReferenceNo` char(16) COLLATE utf8_unicode_ci NOT NULL
